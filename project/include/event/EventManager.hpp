...
class EventManager
{
    public:
        ...
        static BaseEventCallable* createEvent(EventCallbackParam::FunctionType call,const sf::Event::EventType &evtType,const int joyId, const int button)
        {
         ...
         /************************* callback(sf::Event,void*) *****************************/
        static BaseEventCallable* createEvent(EventCallbackParam2::FunctionType call,void* data,const sf::Event &ev)
        {
            return new EventCallbackParam2(call,data,ev);
        };
        static BaseEventCallable* createEvent(EventCallbackParam2::FunctionType call,void* data,const sf::Event::EventType &evtType)
        {
            return new EventCallbackParam2(call,data,evtType);
        };
        static BaseEventCallable* createEvent(EventCallbackParam2::FunctionType call,void* data,const sf::Event::EventType &evtType,const sf::Mouse::Button button)
        {
            return new EventCallbackParam2(call,data,evtType,button);
        };
        static BaseEventCallable* createEvent(EventCallbackParam2::FunctionType call,void* data,const sf::Event::EventType &evtType,const sf::Keyboard::Key code, bool alt=false, bool ctlr = false, bool shift = false, bool system = false)
        {
            return new EventCallbackParam2(call,data,evtType,code,alt,ctlr,shift,system);
        };
        static BaseEventCallable* createEvent(EventCallbackParam2::FunctionType call,void* data,const sf::Event::EventType &evtType,const int joyId, const int button)
        {
            return new EventCallbackParam2(call,data,evtType,joyId,button);
        };
